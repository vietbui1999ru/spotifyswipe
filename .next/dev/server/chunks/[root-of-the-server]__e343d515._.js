...
const env = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$t3$2d$oss$2f$env$2d$nextjs$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createEnv"])({
   ...
   */ server: {
        ...
        LASTFM_API_KEY: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        LASTFM_API_SECRET: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
...
/**
 * Generate API signature for Last.fm API calls
 ...
 */ function generateSignature(params, apiSecret) {
    ...
    sigString += apiSecret;
    return __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHash("md5").update(sigString).digest("hex");
}
/**
 ...
 */ async function callLastfmApi(method, params, sessionKey) {
    ...
    if (sessionKey) {
        apiParams.api_sig = generateSignature(apiParams, apiSecret);
    }
    // Make request
...
"[project]/src/app/api/music/current/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Get user's account with Last.fm credentials
        ...
        const lastfmAccount = user.accounts.find((account)=>account.provider === "lastfm");
        if (!lastfmAccount?.access_token) {
            return Response.json({
        ...
        // Get recent tracks
        const recentTracks = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRecentTracks"])(lastfmAccount.access_token, 1);
        ...
        return Response.json({
            track: {
                ...
                image: currentTrack.image.find((img)=>img.size === "large")?.["#text"] || currentTrack.image[0]?.["#text"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e343d515._.js.map