...
"[project]/src/app/api/auth/callback/lastfm/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("lastfm-callback");
async function GET(request) {
    try {
        ...
        const sessionKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionKey"])(token, apiKey, apiSecret);
        log.info("Successfully got session key");
        log.info("Fetching user profile");
        const profile = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLastfmUserProfile"])(apiKey, sessionKey);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.upsert({
            where: {
        ...
        const sessionToken = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID();
        const expires = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000); // 30 days
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].session.create({
            data: {
                sessionToken,
                userId: user.id,
                expires
        ...
        const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/dashboard", request.nextUrl.origin));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd935f24._.js.map