...
const env = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$t3$2d$oss$2f$env$2d$nextjs$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createEnv"])({
	 ...
	 */ server: {
        ...
        LASTFM_API_KEY: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
        LASTFM_API_SECRET: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string(),
	 ...
	 * `NEXT_PUBLIC_`.
	 */ client: {
        NEXT_PUBLIC_NEXTAUTH_URL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().url()
    },
    /**
	 ...
	 */ runtimeEnv: {
        ...
        NEXT_PUBLIC_NEXTAUTH_URL: ("TURBOPACK compile-time value", "http://127.0.0.1:3000")
    },
    /**
...
path.join(("TURBOPACK compile-time value", "/ROOT/generated/prisma"), "libquery_engine-darwin-arm64.dylib.node");
...
"[project]/src/server/logger.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createLogger(context, opts) {
    const requestId = opts?.requestId ?? __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID();
    const userId = opts?.userId;
    function log(level, message, data, duration) {
        emit(level, {
    ...
    return {
        ...
        timed: (message, data, duration)=>log("info", message, data, duration),
        requestId,
...
async function withTiming(logger, label, fn) {
...
"[project]/src/server/auth/lastfm-provider.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const lastfmProvider = {
    ...
    profile (profile) {
        return {
            ...
            image: profile.user.image?.find((img)=>img.size === "large")?.["#text"] || null
        };
    },
    // Last.fm branding
    style: {
...
const __TURBOPACK__default__export__ = lastfmProvider;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/logger.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/auth/lastfm-provider.ts [app-route] (ecmascript)");
;
;
;
;
const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("auth");
const authConfig = {
    trustHost: true,
    providers: [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["lastfmProvider"]
    ],
...
const configWithUrl = {
    ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authConfig"],
    // Explicitly set the base URL from environment
    basePath: "/api/auth"
};
const { auth: uncachedAuth, handlers, signIn, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(configWithUrl);
...
const createTRPCContext = async (opts)=>{
    ...
    const requestId = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].randomUUID();
    return {
...
"[project]/src/server/errors.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var ErrorCode = /*#__PURE__*/ function(ErrorCode) {
    ...
    ErrorCode["LASTFM_API_ERROR"] = "LASTFM_API_ERROR";
...
const TRPC_CODE_MAP = {
    ...
    ["NOT_FOUND"]: "NOT_FOUND",
    ["CONFLICT"]: "CONFLICT",
    ["LASTFM_API_ERROR"]: "INTERNAL_SERVER_ERROR",
...
function toTRPCError(err) {
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$trpc$2f$server$2f$dist$2f$tracked$2d$D4V22yc5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRPCError"]({
        code: TRPC_CODE_MAP[err.code],
        message: err.message,
        cause: err
    });
}
function isTRPCError(err) {
    return err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$trpc$2f$server$2f$dist$2f$tracked$2d$D4V22yc5$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TRPCError"];
}
}),
"[project]/src/server/api/routers/playlist.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/errors.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/logger.ts [app-route] (ecmascript)");
;
;
;
;
const playlistRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTRPCRouter"])({
    /**
	 ...
	 */ getAll: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].query(async ({ ctx })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.getAll", {
            userId: ctx.session.user.id
        });
        log.info("Fetching all playlists");
        try {
            const playlists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch playlists", ()=>ctx.db.playlist.findMany({
                    where: {
                        userId: ctx.session.user.id
                    },
                    include: {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to fetch playlists"));
        }
    }),
    /**
	 ...
	 */ getById: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.getById", {
            userId: ctx.session.user.id
        });
        log.info("Fetching playlist", {
            playlistId: input.id
        });
        const playlist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch playlist", ()=>ctx.db.playlist.findUnique({
                where: {
                    id: input.id
                },
                include: {
        ...
        if (!playlist) {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].NOT_FOUND, "Playlist not found"));
        }
        if (playlist.userId !== ctx.session.user.id) {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].UNAUTHORIZED, "Not your playlist"));
        }
        log.info("Playlist fetched", {
	 ...
	 */ create: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500).optional(),
        isPublic: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].boolean().optional().default(true)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.create", {
            userId: ctx.session.user.id
        });
        ...
        try {
            const playlist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create playlist", ()=>ctx.db.playlist.create({
                    data: {
                        name: input.name,
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to create playlist"));
        }
    }),
    /**
	 ...
	 */ update: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        description: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500).optional(),
        coverImage: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.update", {
            userId: ctx.session.user.id
        });
        ...
        try {
            const { id, ...data } = input;
            const playlist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Update playlist", ()=>ctx.db.playlist.update({
                    where: {
                        id
                    },
                    data
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to update playlist"));
        }
    }),
    /**
	 ...
	 */ delete: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.delete", {
            userId: ctx.session.user.id
        });
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Delete playlist", ()=>ctx.db.playlist.delete({
                    where: {
                        id: input.id
                    }
                }));
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to delete playlist"));
        }
    }),
    /**
	 * Add a song to a playlist (upserts the song first, then adds PlaylistSong)
	 */ addSong: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        playlistId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        songData: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
            ...
            artist: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
            album: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
            albumArt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
            lastfmUrl: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
            externalId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
        })
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.addSong", {
            userId: ctx.session.user.id
        });
        ...
        try {
            // Upsert the song
            const song = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Upsert song", ()=>ctx.db.song.upsert({
                    where: {
            ...
            const playlistSong = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Add PlaylistSong", ()=>ctx.db.playlistSong.upsert({
                    where: {
                        playlistId_songId: {
                            playlistId: input.playlistId,
                            songId: song.id
            ...
            log.error("Failed to add song to playlist", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to add song to playlist"));
        }
    }),
    /**
	 * Remove a song from a playlist (verify ownership)
	 */ removeSong: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        playlistId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        songId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.removeSong", {
            userId: ctx.session.user.id
        });
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Delete PlaylistSong", ()=>ctx.db.playlistSong.delete({
                    where: {
                        playlistId_songId: {
                            playlistId: input.playlistId,
                            songId: input.songId
            ...
            log.error("Failed to remove song from playlist", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to remove song from playlist"));
        }
    }),
    /**
	 * Reorder songs in a playlist (update positions)
	 */ reorderSongs: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        playlistId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        songIds: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1))
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("playlist.reorderSongs", {
            userId: ctx.session.user.id
        });
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Reorder songs", ()=>ctx.db.$transaction(input.songIds.map((songId, index)=>ctx.db.playlistSong.update({
                        where: {
                            playlistId_songId: {
                                playlistId: input.playlistId,
                                songId
            ...
            log.error("Failed to reorder songs", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to reorder songs"));
        }
    })
});
}),
"[project]/src/server/api/routers/social.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const socialRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTRPCRouter"])({
    /**
	 * Share a playlist as a social post
	 */ sharePlaylist: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        playlistId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        caption: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().max(500).optional()
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.sharePlaylist", {
            userId: ctx.session.user.id
        });
        log.info("Sharing playlist", {
            playlistId: input.playlistId
        });
        // Verify playlist ownership
        const playlist = await ctx.db.playlist.findUnique({
        ...
        if (playlist.sharedPost) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].CONFLICT, "Playlist already shared"));
        }
        try {
            const post = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create social post", ()=>ctx.db.socialPost.create({
                    data: {
            ...
            log.info("Playlist shared", {
                postId: post.id
            });
            return post;
        } catch (err) {
            log.error("Failed to share playlist", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to share playlist"));
        }
    }),
    /**
	 * Get paginated social feed
	 */ getFeed: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        limit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1).max(50).optional().default(20),
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.getFeed");
        log.info("Fetching social feed", {
            limit: input.limit
        });
        try {
            const posts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch feed", ()=>ctx.db.socialPost.findMany({
                    include: {
                        user: {
                            select: {
                                id: true,
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to fetch social feed"));
        }
    }),
    /**
	 * Get a single social post by ID with full details
	 */ getPost: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        id: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).query(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.getPost");
        log.info("Fetching post", {
            postId: input.id
        });
        const post = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch post", ()=>ctx.db.socialPost.findUnique({
                where: {
                    id: input.id
                },
                include: {
        ...
        if (!post) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].NOT_FOUND, "Post not found"));
        }
    ...
    /**
	 * Like a social post
	 */ likePost: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        postId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.likePost", {
            userId: ctx.session.user.id
        });
        ...
        try {
            const like = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create like", ()=>ctx.db.like.upsert({
                    where: {
                        userId_socialPostId: {
                            userId: ctx.session.user.id,
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to like post"));
        }
    }),
    /**
	 * Unlike a social post
	 */ unlikePost: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        postId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.unlikePost", {
            userId: ctx.session.user.id
        });
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Delete like", ()=>ctx.db.like.delete({
                    where: {
                        userId_socialPostId: {
                            userId: ctx.session.user.id,
                            socialPostId: input.postId
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to unlike post"));
        }
    }),
    /**
	 * Add a comment to a social post
	 */ addComment: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        postId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        content: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1).max(1000)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.addComment", {
            userId: ctx.session.user.id
        });
        ...
        try {
            const comment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create comment", ()=>ctx.db.comment.create({
                    data: {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to add comment"));
        }
    }),
    /**
	 * Delete own comment
	 */ deleteComment: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        commentId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.deleteComment", {
            userId: ctx.session.user.id
        });
        ...
        if (!comment) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].NOT_FOUND, "Comment not found"));
        }
        if (comment.userId !== ctx.session.user.id) {
            log.warn("Unauthorized comment delete attempt");
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].UNAUTHORIZED, "Not your comment"));
        }
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Delete comment", ()=>ctx.db.comment.delete({
                    where: {
                        id: input.commentId
                    }
                }));
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to delete comment"));
        }
    }),
    /**
	 * Follow a user
	 */ followUser: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.followUser", {
            userId: ctx.session.user.id
        });
        ...
        if (input.userId === ctx.session.user.id) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].INVALID_INPUT, "Cannot follow yourself"));
        }
        ...
        if (!targetUser) {
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].NOT_FOUND, "User not found"));
        }
        try {
            const follow = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create follow", ()=>ctx.db.follow.upsert({
                    where: {
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to follow user"));
        }
    }),
    /**
	 * Unfollow a user
	 */ unfollowUser: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        userId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.unfollowUser", {
            userId: ctx.session.user.id
        });
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Delete follow", ()=>ctx.db.follow.delete({
                    where: {
                        followerId_followingId: {
                            followerId: ctx.session.user.id,
                            followingId: input.userId
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to unfollow user"));
        }
    }),
    /**
	 * Get a user's public profile with stats
	 */ getUserProfile: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        userId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).query(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.getUserProfile");
        log.info("Fetching user profile", {
            userId: input.userId
        });
        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch user profile", ()=>ctx.db.user.findUnique({
                where: {
                    id: input.userId
                },
                select: {
	 ...
	 */ addPlaylistFromPost: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        postId: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).mutation(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("social.addPlaylistFromPost", {
            userId: ctx.session.user.id
        });
        log.info("Copying playlist from post", {
            postId: input.postId
        });
        ...
        try {
            ...
            const newPlaylist = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Create playlist copy", ()=>ctx.db.playlist.create({
                    data: {
            ...
            log.error("Failed to copy playlist", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to copy playlist"));
        }
    })
});
}),
"[project]/src/server/auth/lastfm.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function generateApiSig(params, apiSecret) {
    ...
    sigString += apiSecret;
    return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["default"].createHash("md5").update(sigString).digest("hex");
}
/**
 * Make an authenticated request to Last.fm API
 */ async function callLastfmApi(method, params, sessionKey) {
    const apiKey = process.env.LASTFM_API_KEY;
    const apiSecret = process.env.LASTFM_API_SECRET;
    if (!apiKey || !apiSecret) {
        throw new Error("Last.fm API credentials not configured (LASTFM_API_KEY, LASTFM_API_SECRET)");
    }
...
async function getRecentTracks(sessionKey, limit = 10) {
    return callLastfmApi("user.getRecentTracks", {
        limit: String(limit)
    }, sessionKey);
}
async function getTopTracks(sessionKey, period = "overall", limit = 10) {
    return callLastfmApi("user.getTopTracks", {
        period,
        limit: String(limit)
    }, sessionKey);
}
async function getSimilarArtists(artistName, limit = 10) {
    return callLastfmApi("artist.getSimilar", {
        artist: artistName,
        limit: String(limit)
    });
}
async function getArtistInfo(artistName) {
    return callLastfmApi("artist.getInfo", {
        artist: artistName
    });
}
async function getTrackInfo(trackName, artistName) {
    return callLastfmApi("track.getInfo", {
        track: trackName,
        artist: artistName
    });
}
async function getTopArtists(sessionKey, period = "overall", limit = 10) {
    return callLastfmApi("user.getTopArtists", {
        period,
        limit: String(limit)
    }, sessionKey);
}
async function searchTracks(query, limit = 10) {
    return callLastfmApi("track.search", {
        track: query,
        limit: String(limit)
    });
}
async function getArtistTopTracks(artistName, limit = 10) {
    return callLastfmApi("artist.getTopTracks", {
        artist: artistName,
        limit: String(limit)
    });
}
async function getUserInfo(sessionKey) {
    return callLastfmApi("user.getInfo", {
        user: "me"
    }, sessionKey);
}
async function getSessionKey(token, apiKey, apiSecret) {
    const params = {
        api_key: apiKey,
    ...
    if (!response.ok) {
        throw new Error(`Failed to get Last.fm session key: ${response.statusText}`);
    }
    const data = await response.json();
    if (data.error) {
...
async function getLastfmUserProfile(apiKey, sessionKey) {
    const params = {
        api_key: apiKey,
        method: "user.getInfo",
        sk: sessionKey
    ...
    if (!response.ok) {
        throw new Error(`Failed to get Last.fm user profile: ${response.statusText}`);
    }
    const data = await response.json();
    if (data.error) {
        throw new Error(`Last.fm API error (${data.error}): ${data.message}`);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__ = __turbopack_context__.i("[project]/node_modules/zod/v3/external.js [app-route] (ecmascript) <export * as z>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/trpc.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/auth/lastfm.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/errors.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/logger.ts [app-route] (ecmascript)");
;
;
...
const songRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTRPCRouter"])({
	 ...
	 */ search: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        ...
        limit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1).max(50).optional().default(10)
    })).query(async ({ input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("song.search");
        log.info("Searching tracks", {
            query: input.query,
            limit: input.limit
        });
        try {
            const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Last.fm track search", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["searchTracks"])(input.query, input.limit));
            ...
            return tracks.map((t)=>({
                    ...
                    image: t.image?.find((img)=>img.size === "large")?.["#text"] || t.image?.[0]?.["#text"] || null
                }));
        } catch (err) {
            log.error("Search failed", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].LASTFM_API_ERROR, "Failed to search tracks"));
        }
    }),
    /**
	 * Get detailed track info from Last.fm
	 */ getInfo: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["publicProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        track: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        artist: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1)
    })).query(async ({ input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("song.getInfo");
        log.info("Fetching track info", {
            track: input.track,
            artist: input.artist
        });
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Last.fm track.getInfo", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTrackInfo"])(input.track, input.artist));
            const track = result.track;
            log.info("Track info fetched", {
                name: track.name
            });
            return {
                name: track.name,
                ...
                album: track.album ? {
                    ...
                    url: track.album.url,
                    image: track.album.image?.find((img)=>img.size === "large")?.["#text"] || track.album.image?.[0]?.["#text"] || null
                } : null,
                image: track.image?.find((img)=>img.size === "large")?.["#text"] || track.image?.[0]?.["#text"] || null,
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].LASTFM_API_ERROR, "Failed to get track info"));
        }
    }),
    /**
	 * Find song in DB or create it
	 */ findOrCreate: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        artist: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
        album: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        albumArt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("song.findOrCreate", {
            userId: ctx.session.user.id
        });
        ...
        try {
            ...
            log.info("Song upserted", {
                songId: song.id
            });
            return song;
        } catch (err) {
            log.error("Failed to upsert song", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to create or find song"));
        }
    })
});
}),
"[project]/src/server/api/routers/swipe.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function getLastfmSessionKey(userId) {
    ...
    if (!account?.access_token) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].AUTH_FAILED, "Last.fm account not connected");
    }
    return account.access_token;
}
const swipeRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTRPCRouter"])({
    /**
	 ...
	 */ getDiscoveryFeed: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        limit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().min(1).max(50).optional().default(20)
    })).query(async ({ ctx, input })=>{
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("swipe.getDiscoveryFeed", {
            userId: ctx.session.user.id
        });
        log.info("Generating discovery feed", {
            limit: input.limit
        });
        try {
            const sessionKey = await getLastfmSessionKey(ctx.session.user.id);
            // Get user's top artists
            const topArtistsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch top artists", ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTopArtists"])(sessionKey, "3month", 5));
            ...
            const similarResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch similar artists", ()=>Promise.all(topArtists.slice(0, 3).map((artist)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSimilarArtists"])(artist.name, 3).catch(()=>({
                            similarartists: {
                                artist: []
                            }
                        })))));
            ...
            const trackResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch artist top tracks", ()=>Promise.all(artistsToFetch.map((artist)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$lastfm$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getArtistTopTracks"])(artist, 5).catch(()=>({
                            toptracks: {
                                track: []
                            }
                        })))));
            ...
            const swipedSongs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch swiped songs", ()=>ctx.db.swipeAction.findMany({
                    where: {
                        userId: ctx.session.user.id
                    },
                    select: {
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]) throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(err);
            log.error("Failed to generate discovery feed", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].LASTFM_API_ERROR, "Failed to generate discovery feed"));
        }
    }),
    /**
	 * Record a swipe action (like, skip, superlike)
	 */ recordSwipe: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        songData: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
            title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
            artist: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(1),
            album: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("swipe.recordSwipe", {
            userId: ctx.session.user.id
        });
        ...
        try {
            ...
            const swipeAction = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Upsert swipe action", ()=>ctx.db.swipeAction.upsert({
                    where: {
                        userId_songId: {
                            userId: ctx.session.user.id,
                            songId: song.id
            ...
            log.error("Failed to record swipe", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to record swipe"));
        }
    }),
    /**
	 * Get swipe history with optional filtering and cursor pagination
	 */ getHistory: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["protectedProcedure"].input(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
        action: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
            "liked",
            "skipped",
            "superliked"
        ...
        const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createLogger"])("swipe.getHistory", {
            userId: ctx.session.user.id
        });
        ...
        try {
            ...
            const swipes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$logger$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withTiming"])(log, "Fetch swipe history", ()=>ctx.db.swipeAction.findMany({
                    where,
                    include: {
                        song: true
                    },
            ...
            log.error("Failed to fetch swipe history", {
                error: err
            });
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toTRPCError"])(new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"](__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$errors$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ErrorCode"].DB_ERROR, "Failed to fetch swipe history"));
        }
    })
});
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$playlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/routers/playlist.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$social$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/routers/social.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$song$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/routers/song.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$swipe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/routers/swipe.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/server/api/trpc.ts [app-route] (ecmascript)");
;
;
;
...
const appRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$trpc$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createTRPCRouter"])({
    ...
    playlist: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$playlist$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["playlistRouter"],
    swipe: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$swipe$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["swipeRouter"],
    social: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$api$2f$routers$2f$social$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialRouter"]
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__893724be._.js.map