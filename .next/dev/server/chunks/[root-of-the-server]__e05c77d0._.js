...
const env = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$t3$2d$oss$2f$env$2d$nextjs$2f$dist$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["createEnv"])({
   ...
   */ server: {
        ...
        LASTFM_API_KEY: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
        LASTFM_API_SECRET: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().optional(),
...
;
/**
 * Generate Last.fm API signature (MD5 hash)
 * Required for all Last.fm API calls with session key
 */ function generateApiSig(params, apiSecret) {
    const sorted = Object.keys(params).sort().map((k)=>`${k}${params[k]}`).join("");
    return __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHash("md5").update(sorted + apiSecret).digest("hex");
}
/**
 ...
 */ async function getUserProfile(apiKey, sessionKey) {
    const params = {
        api_key: apiKey,
        method: "user.getInfo",
        sk: sessionKey
    };
    const api_sig = generateApiSig(params, process.env.LASTFM_API_SECRET || "");
    const queryParams = new URLSearchParams({
        ...params,
        api_sig,
        format: "json"
...
;
const authConfig = {
    // CRITICAL: Force NextAuth to use NEXTAUTH_URL instead of auto-detecting from request
    trustHost: true,
    providers: [
        // DiscordProvider,
...
async function middleware(request) {
    ...
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$auth$2f$index$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["auth"])(request);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__e05c77d0._.js.map